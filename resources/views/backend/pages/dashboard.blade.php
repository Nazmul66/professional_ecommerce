            ...
            <div class="col-md-12 col-sm-6"> 
                ...
                <div class="p-4">
                    ...
                    <div class="img-boostup">
                        <img class="img-boostup-img-1" src="{{ asset('public/backend/assets/images/dashboard-3/boostup1.png') }}" alt="boostup">
                        <img class="img-boostup-img-2" src="{{ asset('public/backend/assets/images/dashboard-3/boostup2.png') }}" alt="boostup"></div>
        ...
        <div class="col-xxl-4 col-md-6 box-col-6">
            ...
            <div class="card-body pt-0">
                ...
                <ul>
                    ...
                    <div>
                        <img class="img-fluid product-img" src="{{ asset('public/backend/assets/images/dashboard-3/product/1.png') }}" alt="product"/></div>
                    ...
                    <li class="d-flex top-product gap-2">
                    <div>
                        <img class="img-fluid product-img" src="{{ asset('public/backend/assets/images/dashboard-3/product/2.png') }}" alt="product"/></div>
                    <div class="w-100 d-flex justify-content-between align-items-center">
                        <div class="product-details">
                    ...
                    <li class="d-flex top-product gap-2">
                    <div>
                        <img class="img-fluid product-img" src="{{ asset('public/backend/assets/images/dashboard-3/product/3.png') }}" alt="product"/></div>
                    <div class="w-100 d-flex justify-content-between align-items-center">
                        <div class="product-details">
                    ...
                    <li class="d-flex top-product gap-2">
                    <div>
                        <img class="img-fluid product-img" src="{{ asset('public/backend/assets/images/dashboard-3/product/4.png') }}" alt="product"/></div>
                    <div class="w-100 d-flex justify-content-between align-items-center">
                        <div class="product-details">
            ...
            <div class="card-body pt-0"> 
                ...
                <ul> 
                    ...
                    <div class="space-common d-flex user-name">
                        <img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('public/backend/assets/images/user/22.png') }}" alt="user"/>
                    ...
                    <li>
                    <div class="space-common d-flex user-name">
                        <img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('public/backend/assets/images/user/28.png') }}" alt="user"/>
                        <div class="common-space w-100">
                        <div>
                    ...
                    <li>
                    <div class="space-common d-flex user-name">
                        <img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('public/backend/assets/images/user/26.png') }}" alt="user"/>
                        <div class="common-space w-100">
                        <div>
                    ...
                    <li>
                    <div class="space-common d-flex user-name">
                        <img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('public/backend/assets/images/user/24.png') }}" alt="user"/>
                        <div class="common-space w-100">
                        <div>
                    ...
                    <li>
                    <div class="space-common d-flex user-name">
                        <img class="img-40 rounded-circle img-fluid me-2" src="{{ asset('public/backend/assets/images/user/49.png') }}" alt="user"/>
                        <div class="common-space w-100">
                        <div>
                ...
                <table class="order-table overflow-hidden project-table w-100 activity-log">
                        ...
                        <div class="team-activity">
                            ...
                            <div class="common-space gap-2 "> 
                                <div class="user-activity me-3">
                                    <img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('public/backend/assets/images/user/50.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Floyd Miles</a></div>
                    ...
                    <tr>
                        ...
                        <div class="team-activity">
                            ...
                            <div class="common-space gap-2 "> 
                                <div class="user-activity me-3">
                                    <img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('public/backend/assets/images/user/51.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Ralph Edwards</a></div>
                    ...
                    <tr>
                        ...
                        <div class="team-activity">
                            ...
                            <div class="common-space gap-2 "> 
                                <div class="user-activity me-3">
                                    <img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('public/backend/assets/images/user/33.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Esther Howard</a></div>
                    ...
                    <tr>
                        ...
                        <div class="team-activity">
                            ...
                            <div class="common-space gap-2 "> 
                                <div class="user-activity me-3">
                                    <img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('public/backend/assets/images/user/52.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Jacob Jones</a></div>
                    ...
                    <tr>
                        ...
                        <div class="team-activity">
                            ...
                            <div class="common-space gap-2 "> 
                                <div class="user-activity me-3">
                                    <img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('public/backend/assets/images/user/53.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Theresa Webb</a></div>
                    ...
                    <tr>
                        ...
                        <div class="team-activity">
                            ...
                            <div class="common-space gap-2 "> 
                                <div class="user-activity me-3">
                                    <img class="rounded-circle p-1 img-fluid me-3 img-50" src="{{ asset('public/backend/assets/images/user/54.png') }}" alt="user"><a class="f-10 f-w-500 username" href="edit-profile.html">Annette Black</a></div>
                                <div class="activity-time"><span class="f-light f-w-500 f-10">12 min ago</span></div>
                            </div>
                            <div class="subtitle"> 
